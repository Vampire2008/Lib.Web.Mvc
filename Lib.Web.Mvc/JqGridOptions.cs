...
namespace Lib.Web.Mvc.JqGridFork
{
	...
	public class JqGridOptions
	{
		...
		/// <summary>
		/// Enables editing of the next row editable cell in case tab is pressed and a last edited cell of current row is reached. (Gurrido JqGrid 5.3.2)
		/// </summary>
		public bool? EditNextRowCell { get; set; }
		...
		/// <summary>
		/// Gets or sets show pager buttons on pager
		/// </summary>
		public bool? PagerButtons { get; set; }

		/// <summary>
		/// Gets or sets show input box on pager
		/// </summary>
		public bool? PagerInput { get; set; }

		internal bool IsPagerTextSetted { get; private set; }
		/// <summary>
		/// Get or sets text information about current page status
		/// </summary>
		...
		/// <summary>
		/// Gets or sets option that keep the selected rows in multiselect mode when paging and sorting is performed. (Guriddo JqGrid 5.3.2)
		/// </summary>
		...
		/// <summary>
		/// Gets or sets tree reader. Extends the colModel defined in the basic grid when treeGrid is set to true. The fields described here are appended to end of the colModel array and are hidden. This means that the data returned from the server should have values for these fields.
		/// </summary>
		public JqGridTreeReader TreeReader { get; set; }

		/// <summary>
		/// Enables (if set to true) the tree grid pagging with root nodes.
		/// <remarks>Available only on Guriddo JqGrid since 5.3</remarks>
		/// </summary>
		public bool? TreeGridBigData { get; set; }

		/// <summary>
		/// This class sets the icons used in the tree grid.
		/// </summary>
		public JqGridTreeIcons TreeIcons { get; set; }

		/// <summary>
		/// Defines the level from where the root element begins when treeGrid is enabled.
		/// </summary>
		public int? TreeRootLevel { get; set; }
