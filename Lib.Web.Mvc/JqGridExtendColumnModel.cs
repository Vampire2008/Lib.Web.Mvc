...
namespace Lib.Web.Mvc.JqGridFork
{
	...
	public class JqGridExtendColumnModel
	{
		...
		/// <summary>
		/// Gets or sets the dictionary where keys should be valid attributes for the element in edit mode.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the dictionary where keys should be CSS styles for the label (will be applied only if Class is null or empty string).
		/// </summary>
		...
		/// <summary>
		///Gets or sets the dictionary where keys should be valid attributes for the label.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the dictionary where keys should be valid attributes for the element in search mode.
		/// </summary>
