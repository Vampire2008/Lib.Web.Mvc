...
namespace Lib.Web.Mvc.JqGridFork.DataAnnotations
{
	internal static class JqGridModelMetadataExtensions
	{
		...
		internal static void SetColumnTooltip(this ModelMetadata metadata, SettedString tooltip)
		{
			metadata.AdditionalValues.Add(_tooltipKey, tooltip);
		}

		internal static SettedString GetColumnTooltip(this ModelMetadata metadata)
		{
