...
namespace Lib.Web.Mvc.JqGridFork.DataAnnotations
{
	...
	public sealed class JqGridColumnLayoutAttribute : Attribute, IMetadataAware
	{
		...
		internal bool IsTooltipSetted { get; private set; }

		/// <summary>
		/// Gets or sets differrent title attribute for header
		/// </summary>
		...
		public void OnMetadataCreated(ModelMetadata metadata)
		{
			...
			metadata.SetColumnTooltip(new SettedString(IsTooltipSetted, Tooltip));
		}
		#endregion
	}
}
